...
#CV# Change working directory as needed. All files should be in the same folder with this script.
setwd('C:/Users/cassandv/Documents/Circadian nonrestored clocks (Sassone-Corsi)')

##CV# Load in data.
#CV# Read in curated lists of secreted proteins, along with the database of traits.
...
#CV# Keep only genes that are counted in all datasets.
...
#CV# Rename as needed for consistency.
...
target_cor = bicorAndPvalue(bin_mat, h2, use = 'p') #CV# this will take a long time
tt1 = target_cor$p
tt1[is.na(tt1)] = 0.5
